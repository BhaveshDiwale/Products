...
import SellerUtility from '@/components/ui/SellerUtility'
    ...
    <>
      ...
      <div className="sellerDetail flex xl:flex-row flex-col">
        ...
        <div className="flex border shadow-lg rounded-xl px-4 py-4 mb-8 flex-col md:flex-row">
            <img src="/images/photo.png" alt="" className=' mb-4 me-4 lg:me-8 w-28 h-28'/>
       ...
       <SellerUtility/>
        ...
        <h4 className='font-bold text-xl mb-8'>More Products from the Seller</h4>
        <div className="flex flex-col md:flex-row">

      <div className="card rounded-2xl shadow-lg xl:w-96 lg:w-56 py-2 mb-4 px-4 xl:me-8 lg:me-4">
      ...
      <div className="card rounded-2xl shadow-lg xl:w-96 lg:w-56 py-2 mb-4 px-4 xl:mx-8 lg:mx-4">
